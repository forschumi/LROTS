// megafunction wizard: %altmemphy v12.1%
// GENERATION: XML
...
// ============================================================
// Generated by altmemphy 12.1 [Altera, IP Toolbench 1.3.0 Build 177]
// ************************************************************
...
module ddr2_phy (
	...
	input		soft_reset_n;
	input	[3:0]	ctl_dqs_burst;
	input	[3:0]	ctl_wdata_valid;
	input	[63:0]	ctl_wdata;
	input	[7:0]	ctl_dm;
	input	[12:0]	ctl_addr;
	input	[2:0]	ctl_ba;
	input	[0:0]	ctl_cas_n;
	...
	defparam
		...
		ddr2_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6667,
		ddr2_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6667 ps",
		ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1074,
		ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1024,
		ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ddr2_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="12.1"  build="198"  iptb_version="1.3.0 Build 177"  format_version="120" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (JEDEC DDR2-400 256Mb x8)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=F:\work_dir\FPGA\ALINX3402\32bit_ep4ce15_ddr_top/ddr2_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
